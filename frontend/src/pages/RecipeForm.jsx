  ...
  return (
    <div className="mx-auto max-w-md border-2 border-white p-4">
        ...
        <form action="" className="space-y-5" onSubmit={submit}>
            ...
            <input value={title} onChange={e => setTitle(e.target.value)} type="text" placeholder="Recipe Title" className="w-full p-1"></input>
            ...
            <div className='flex space-x-2 items-center'>
              <input value={newIngredient} onChange={e => setNewIngredient(e.target.value)} type='text' placeholder="Recipe Ingredient" className="w-full p-1"/>{newIngredient}
              <img src={plus} alt="" className='cursor-pointer' onClick={addIngredient}></img>
            </div>
            <div>
